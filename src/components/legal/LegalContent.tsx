    ...
    <Container size="md">
      <div className={cn("prose prose-stone max-w-none py-12", className)}>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 bg-card rounded-xl shadow-sm border border-stone-100 p-6 md:p-8 lg:p-10">
            {children}
          </div>
          ...
          {showBusinessData && (
            <div className="md:col-span-4">
              <div className="sticky top-24">
                ...
                <div className="bg-card rounded-lg shadow-sm border border-stone-200 p-4">
