...
const DevisCTASection = ({ prestation }: DevisCTASectionProps) => {
  return (
    <div className="bg-khaki-50 p-6 rounded-lg shadow-sm my-8">
      <h3 className="text-2xl font-medium mb-4">Vous avez un projet de {prestation} ?</h3>
      <p className="mb-6">
        <InternalLinkText 
          text={`Contactez-nous pour un premier échange sans engagement. Nous serons ravis d'étudier votre projet de ${prestation} et de vous proposer des solutions adaptées à vos besoins et à votre budget.`}
          maxOccurrences={1}
        />
      </p>
...
export default DevisCTASection; 