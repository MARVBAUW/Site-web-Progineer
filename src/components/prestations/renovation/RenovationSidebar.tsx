      ...
      <ul className="space-y-4">
        <li className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Analyse approfondie de votre bien pour identifier les points d'amélioration.</p>
          </div>
        </li>
        <li className="flex items-start">
          <span className="text-khaki-600 mr-2 mt-1 text-lg">✓</span>
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Reconception intelligente pour maximiser le potentiel de votre habitat.</p>
          </div>
        </li>
        <li className="flex items-start">
          <span className="text-khaki-600 mr-2 mt-1 text-lg">✓</span>
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Amélioration significative de l'isolation et de l'efficacité énergétique.</p>
          </div>
        </li>
        <li className="flex items-start">
          <span className="text-khaki-600 mr-2 mt-1 text-lg">✓</span>
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Augmentation de la valeur de votre bien immobilier.</p>
          </div>
        </li>
      </ul>
