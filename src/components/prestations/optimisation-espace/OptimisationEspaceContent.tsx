  ...
  return (
    <>
      <div id="overview" className="mb-12 md:mb-16 p-4 md:p-8 bg-white dark:bg-slate-900 rounded-xl shadow-sm">
        ...
        <div className="mb-12">
          <img 
            src="/images/prestations/PROGINEER-22-_resultat.webp" 
      ...
      <div id="process">
        ...
        <div className="relative pb-12">
          ...
          <div className="relative pl-16 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Nous prenons le temps de comprendre votre mode de vie, vos contraintes et vos attentes pour définir un programme adapté à vos besoins spécifiques.</p>
          </div>
          ...
          <div className="relative pl-16 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Étude approfondie de votre logement pour identifier ses contraintes, ses atouts et les opportunités d'optimisation.</p>
          </div>
          ...
          <div className="relative pl-16 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Élaboration de plusieurs scénarios d'aménagement avec plans 2D, vues 3D et échantillons de matériaux pour vous aider à visualiser les transformations.</p>
          </div>
          ...
          <div className="relative pl-16 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Organisation du chantier, coordination des différents corps de métier et établissement d'un calendrier précis des travaux.</p>
          </div>
          ...
          <div className="relative pl-16">
            ...
            <p className="text-gray-600 dark:text-gray-300">Supervision de toutes les étapes du chantier pour garantir la qualité des finitions et le respect des délais.</p>
          </div>
        </div>
      </div>
