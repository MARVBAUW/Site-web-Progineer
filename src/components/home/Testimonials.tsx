      ...
      <Container>
        <div className="text-center mb-12 max-w-2xl mx-auto relative">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-block px-4 py-1 mb-4 rounded-full bg-card/20 text-white text-sm font-medium backdrop-blur-sm"
          >
            Témoignages
          </motion.div>
        ...
        <div className="relative px-8">
          <button
            ...
            className="absolute left-0 z-10 top-1/2 -translate-y-1/2 bg-card/10 hover:bg-card/20 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300"
          ...
          <button
            ...
            className="absolute right-0 z-10 top-1/2 -translate-y-1/2 bg-card/10 hover:bg-card/20 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300"
