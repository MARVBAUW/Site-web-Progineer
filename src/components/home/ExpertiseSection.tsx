...
const ExpertiseSection = () => {
  ...
  return (
    <section className="py-28 bg-gradient-to-b from-stone-50 to-white dark:from-slate-900 dark:to-slate-800 relative overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <Container>
        ...
        >
          {[
            ...
            >
              <div className="bg-card p-8 rounded-xl shadow-sm border border-border h-full relative overflow-hidden group">
                {/* Background gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-transparent to-stone-50 dark:to-slate-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white group-hover:text-progineer-gold transition-colors duration-300">
                    {item.title}
                  </h3>
                  
                  <p className="text-gray-600 dark:text-gray-300 group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300">
                    {item.description}
                  </p>
                </div>
              </div>
