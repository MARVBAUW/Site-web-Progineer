...
const StatsSection = () => {
  ...
  return (
    <section ref={ref} className="py-24 bg-gradient-to-b from-white to-stone-50 dark:from-slate-800 dark:to-slate-900 relative overflow-hidden">
      {/* Éléments décoratifs */}
              <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-stone-100/50 dark:from-slate-700/50 to-transparent"></div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{stat.label}</h3>
