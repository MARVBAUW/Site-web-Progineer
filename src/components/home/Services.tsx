...
const Services = () => {
  ...
  return (
    <section id="services-section" className="py-28 bg-gradient-to-br from-stone-50 to-stone-100/50 dark:from-slate-800 dark:to-slate-900/50 relative overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <Container>
        ...
        >
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-semibold mb-4 text-gray-900 dark:text-white">Des solutions complètes pour votre projet
            </motion.h2>
              ...
              return (
                ...
                >
                  <div className="transform-style-3d h-full w-full">
                    <div 
                      className={`${service.bgColor} rounded-xl p-7 shadow-sm border border-border 
                    ...
                    >
                      <div className="flex flex-col h-full">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white group-hover:translate-z-10 transition-transform duration-300">
                          {service.title}
                        </h3>
                        ...
                        <Link 
                          to={service.link} 
                          className={`inline-flex items-center text-gray-600 dark:text-gray-300 hover:${service.iconColor} font-medium transition-colors duration-300 mt-2 group-hover:translate-z-5`}
                        >
