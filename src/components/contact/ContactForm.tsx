        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <select
              id="subject"
              className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-khaki-500 focus:border-transparent transition-colors ${
                errors.subject ? 'border-red-300 bg-red-50' : 'border-border'
              }`}
              aria-required="true"
        ...
        <div className="mb-8">
          <div className="flex items-start">
            <input
              id="consent"
              type="checkbox"
              className={`h-5 w-5 rounded border-border text-khaki-600 focus:ring-khaki-500 mr-2 mt-0.5 ${
      ...
      <div className="mt-8 pt-6 border-t border-border">
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            <a href="tel:+33783762156" className="text-gray-600 dark:text-gray-300 hover:text-khaki-600 transition-colors">
              +33 7 83 76 21 56
            </a>
          </div>
          <div className="flex items-center">
            <Mail className="h-5 w-5 text-khaki-600 mr-3" />
            <a href="mailto:progineer.moe@gmail.com" className="text-gray-600 dark:text-gray-300 hover:text-khaki-600 transition-colors">
