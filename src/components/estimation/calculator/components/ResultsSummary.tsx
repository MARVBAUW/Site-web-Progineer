        ...
        <CardContent className="p-6 space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="bg-muted/50 p-4 rounded-lg">
              <h3 className="text-sm text-low-contrast font-medium">Estimation totale</h3>
              <p className="text-3xl font-bold text-green-600">{formatCurrency(totalAmount)}</p>
            </div>
            
            <div className="bg-muted/50 p-4 rounded-lg">
              <h3 className="text-sm text-low-contrast font-medium">Prix au m²</h3>
