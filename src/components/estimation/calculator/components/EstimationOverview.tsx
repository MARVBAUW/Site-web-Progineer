    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start">
            ...
            <div>
              <div className="text-sm text-low-contrast">Type de projet</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <div className="text-sm text-low-contrast">Surface</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <div className="text-sm text-low-contrast">Localisation</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <div className="text-sm text-low-contrast">Prix au m²</div>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="text-sm text-low-contrast mt-4">
