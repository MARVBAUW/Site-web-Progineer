    ...
    <Card className="print:shadow-none print:border-none">
      ...
      <CardContent className="space-y-6 pt-0">
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            <span className="text-gray-600 dark:text-gray-300">Prix au m²:</span>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-300">Honoraires de maîtrise d'œuvre:</span>
          ...
          <div className="space-y-2">
            ...
            {includeTerrainPrice && formData.landPrice && (
              <>
                <Separator />
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-300">Prix du terrain:</span>
        ...
        <div className="text-xs text-low-contrast mt-6">
