    ...
    <Card className="w-full border shadow-lg print:shadow-none print:border-none">
      <CardContent className="p-0 relative">
        <div className="print:block" id="quote-to-print">
          {/* En-tête */}
          <div className="bg-stone-50 p-6 border-b print:bg-card">
            ...
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div>
                <h3 className="font-bold text-gray-900 dark:text-white mb-1">PGR PROGINEER</h3>
                <p>229 Rue Saint-Honoré</p>
                <p>75001 Paris, France</p>
              </div>
              <div className="text-right">
                <h3 className="font-bold text-gray-900 dark:text-white mb-1">ACTIV TRAVAUX</h3>
          ...
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">{getMissionDescription()}</p>
            
            <div className="flex justify-between text-sm mt-4">
              <div className="flex items-center">
                <Calendar className="h-4 w-4 mr-2 text-low-contrast" />
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-progineer-gold/20">
                  <th className="py-3 px-4 text-left font-semibold text-gray-900 dark:text-white border-b">Libellé</th>
                  <th className="py-3 px-4 text-center font-semibold text-gray-900 dark:text-white border-b">Unité</th>
                  <th className="py-3 px-4 text-center font-semibold text-gray-900 dark:text-white border-b">Quantité</th>
                  <th className="py-3 px-4 text-right font-semibold text-gray-900 dark:text-white border-b">Prix u. HT</th>
                  <th className="py-3 px-4 text-right font-semibold text-gray-900 dark:text-white border-b">TVA</th>
                  <th className="py-3 px-4 text-right font-semibold text-gray-900 dark:text-white border-b">Total HT</th>
                </tr>
              </thead>
              <tbody>
                {quoteItems.map((item, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-card' : 'bg-muted/50'}>
                    <td className="py-3 px-4 border-b">
                      ...
                      {index === 0 && (
                        <div className="text-low-contrast text-xs mt-1">
          ...
          {/* Pied de page */}
          <div className="p-6 text-xs text-gray-600 dark:text-gray-300 border-t bg-muted/50 print:bg-card">
        ...
        <div className="p-4 border-t bg-muted/50 flex justify-between print:hidden">
          <Button 
            variant="outline" 
            size="sm" 
