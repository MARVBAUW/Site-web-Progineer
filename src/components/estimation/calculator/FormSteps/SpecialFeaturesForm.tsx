            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="solarPanels" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-low-contrast">Production d'énergie renouvelable</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="rainwaterHarvesting" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-low-contrast">Système de collecte et stockage</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="homeAutomation" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Domotique</p>
                    <p className="text-sm text-low-contrast">Contrôle intelligent de la maison</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="energyEfficiency" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-low-contrast">Isolation renforcée, matériaux écologiques</p>
                  </div>
                </Label>
              </div>
            </div>
