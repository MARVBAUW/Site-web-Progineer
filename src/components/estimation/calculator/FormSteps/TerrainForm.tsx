            ...
            >
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-low-contrast">Vous êtes déjà propriétaire du terrain</p>
                </div>
            ...
            >
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-low-contrast">Vous n'avez pas encore acquis le terrain</p>
                </div>
