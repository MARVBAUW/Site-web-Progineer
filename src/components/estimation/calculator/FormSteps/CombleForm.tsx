                  ...
                  >
                    {atticOptions.map((option) => (
                      <div key={option.id} className="relative">
                        ...
                        <label
                          htmlFor={option.id}
                          className="flex flex-col items-center border rounded-lg p-4 cursor-pointer transition-all peer-checked:border-progineer-gold peer-checked:bg-progineer-gold/10 peer-focus:ring-2 peer-focus:ring-progineer-gold/30 hover:border-border shadow-sm"
                        >
                          {option.image && (
