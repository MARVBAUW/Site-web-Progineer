  ...
  return (
    <div className={`transform transition-all duration-300 ${
      ...
      <div className="space-y-6">
        ...
        <p className="text-sm text-low-contrast mb-4">
        ...
        <div className="mt-6 bg-card p-4 rounded-md border border-border">
          ...
          {formData.floorTileArea && formData.floorTileArea > 0 && (
            <div className="mt-4 text-sm">
              ...
              <span className="text-gray-600 dark:text-gray-300">Vous avez déjà alloué {formData.floorTileArea}m² de carrelage dans une étape précédente.</span>
            </div>
          )}
        </div>
