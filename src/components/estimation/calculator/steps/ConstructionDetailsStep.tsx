    ...
    <div className={`space-y-6 transform transition-all duration-300 ${
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          {isRenovation && (
            <p className="text-sm text-low-contrast">Surface concernée par le projet de rénovation exemple : 20 m² sur une maison de 100 m²</p>
          )}
          <div className="flex items-center">
            <Input
              ...
              required
            />
            <span className="ml-2 text-gray-600 dark:text-gray-300">m²</span>
          </div>
        </div>
