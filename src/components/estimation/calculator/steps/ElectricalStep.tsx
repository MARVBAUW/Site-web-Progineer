              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="basic" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Installation électrique standard conforme aux normes</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="standard" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Points électriques supplémentaires, prises RJ45, etc.</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="premium" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Système électrique complet avec options avancées</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="smart_home" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Installation connectée, contrôle à distance, automatisation</p>
                  </div>
                </Label>
              </div>
