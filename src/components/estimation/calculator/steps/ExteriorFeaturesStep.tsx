            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="pool" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Piscine</p>
                    <p className="text-sm text-low-contrast">Installation d'une piscine</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="terrace" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Terrasse</p>
                    <p className="text-sm text-low-contrast">Création d'une terrasse</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-3 rounded-md border p-4">
                ...
                <Label htmlFor="outdoorKitchen" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-low-contrast">Installation d'une cuisine d'été</p>
                  </div>
                </Label>
              </div>
            </div>
