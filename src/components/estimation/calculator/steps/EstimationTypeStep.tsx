      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Précision à + ou - 10%</p>
            <p className="text-xs text-low-contrast mt-2">L'estimation rapide demande peu ou pas de connaissances</p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Précision à + ou - 5%</p>
            <p className="text-xs text-low-contrast mt-2">L'estimation précise demande quelques connaissances dans le domaine</p>
          </CardContent>
        </Card>
      </div>
