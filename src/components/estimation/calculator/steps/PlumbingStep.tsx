              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="basic-plumb" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Installation standard avec raccordements nécessaires</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="standard-plumb" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Installation complète avec équipements de qualité</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="premium-plumb" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Installation haut de gamme avec options premium</p>
                  </div>
                </Label>
              </div>
