...
const QuickEstimationStep: React.FC<BaseFormProps> = ({
  ...
  return (
    <div className={`space-y-6 transform transition-all duration-300 ${
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">Quelques questions simples pour estimer votre projet de rénovation</p>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">Indiquez quelle proportion du bien doit être rénovée (%).</p>
          <Input
