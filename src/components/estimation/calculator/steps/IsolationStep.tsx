          ...
          >
            <div className="flex items-center space-x-2 rounded-md border p-4">
              ...
              <Label htmlFor="standard" className="flex flex-1 items-center gap-2 cursor-pointer">
                ...
                <div>
                  <p>Standard (RT2012)</p>
                  <p className="text-sm text-low-contrast">Isolation réglementaire</p>
                </div>
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2 rounded-md border p-4">
              ...
              <Label htmlFor="reinforced" className="flex flex-1 items-center gap-2 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-sm text-low-contrast">Meilleure performance thermique</p>
                </div>
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2 rounded-md border p-4">
              ...
              <Label htmlFor="passive" className="flex flex-1 items-center gap-2 cursor-pointer">
                ...
                <div>
                  <p>Maison passive</p>
                  <p className="text-sm text-low-contrast">Performance thermique maximale</p>
                </div>
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2 rounded-md border p-4">
              ...
              <Label htmlFor="ecological" className="flex flex-1 items-center gap-2 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-sm text-low-contrast">Matériaux naturels et biosourcés</p>
                </div>
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2 rounded-md border p-4">
              ...
              <Label htmlFor="renovation" className="flex flex-1 items-center gap-2 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-sm text-low-contrast">Isolation pour rénovation</p>
                </div>
              </Label>
            </div>
          </RadioGroup>
