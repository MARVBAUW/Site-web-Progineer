...
const CuisineStep: React.FC<BaseFormProps> = ({
  ...
  return (
    <div className={`space-y-6 transform transition-all duration-300 ${
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">Sélectionnez le type de cuisine équipée que vous souhaitez inclure</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center">
                ...
                <Label htmlFor="kitchenette" className="cursor-pointer flex items-center">
                  <Utensils className="h-5 w-5 text-low-contrast mr-2" />
                  <div>
                    <span className="font-medium">Kitchenette</span>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Solution compacte pour petits espaces</p>
                  </div>
                </Label>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="basic" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Cuisine fonctionnelle avec équipements essentiels</p>
                  </div>
                </Label>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="standard" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Cuisine milieu de gamme complète</p>
                  </div>
                </Label>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="premium" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Cuisine haut de gamme avec équipements premium</p>
                  </div>
                </Label>
              </div>
            </CardContent>
