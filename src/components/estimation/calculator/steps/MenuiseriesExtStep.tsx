        ...
        >
          <div className="flex items-center space-x-2 rounded-md border p-4">
            ...
            <Label htmlFor="pvc" className="flex flex-1 items-center gap-2 cursor-pointer">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-low-contrast">Menuiseries en PVC, bon rapport qualité/prix</p>
              </div>
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2 rounded-md border p-4">
            ...
            <Label htmlFor="aluminum" className="flex flex-1 items-center gap-2 cursor-pointer">
              <Home className="h-5 w-5 text-low-contrast" />  {/* Replaced Wind with Home */}
              <div className="space-y-1">
                <p className="font-medium">Aluminum</p>
                <p className="text-sm text-low-contrast">Menuiseries en aluminum, design moderne et durable</p>
              </div>
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2 rounded-md border p-4">
            ...
            <Label htmlFor="wood" className="flex flex-1 items-center gap-2 cursor-pointer">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-low-contrast">Menuiseries en bois, aspect chaleureux et naturel</p>
              </div>
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2 rounded-md border p-4">
            ...
            <Label htmlFor="wood_aluminum" className="flex flex-1 items-center gap-2 cursor-pointer">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-low-contrast">Le meilleur des deux matériaux, bois à l'intérieur et aluminum à l'extérieur</p>
              </div>
            </Label>
          </div>
        </RadioGroup>
