...
const AmenagementExterieursStep: React.FC<BaseFormProps> = ({
  ...
  return (
    <div className={`space-y-6 transform transition-all duration-300 ${
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">Sélectionnez les aménagements extérieurs que vous souhaitez inclure dans votre projet</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Ne pas inclure d'aménagements extérieurs spécifiques</p>
              </div>
            </div>
          </CardContent>
        </Card>
