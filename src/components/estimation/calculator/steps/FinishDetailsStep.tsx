            ...
            >
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="finishEconomic" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Économique</p>
                    <p className="text-sm text-low-contrast">Matériaux basiques, finitions simples</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="finishStandard" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Standard</p>
                    <p className="text-sm text-low-contrast">Bon rapport qualité/prix, finitions soignées</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="finishPremium" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div>
                    <p>Premium</p>
                    <p className="text-sm text-low-contrast">Matériaux haut de gamme, finitions luxueuses</p>
                  </div>
                </Label>
              </div>
            </RadioGroup>
