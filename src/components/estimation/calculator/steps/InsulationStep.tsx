              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="base" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Isolation conforme aux normes actuelles</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="performance" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Isolation renforcée pour économies d'énergie</p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 rounded-md border p-4">
                ...
                <Label htmlFor="ultraPerformance" className="flex flex-1 items-center gap-2 cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-low-contrast">Isolation premium pour maison passive/basse consommation</p>
                  </div>
                </Label>
              </div>
