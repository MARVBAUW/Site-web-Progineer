...
const SolutionsEnvironnementalesStep: React.FC<BaseFormProps> = ({
  ...
  return (
    <div className={`space-y-6 transform transition-all duration-300 ${
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">Quel niveau de solutions écologiques souhaitez-vous intégrer à votre projet ?</p>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="minimal" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Intégration des solutions écologiques de base (+1,8%)</p>
                  </div>
                </Label>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="moderate" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Intégration de solutions écologiques intermédiaires (+3,8%)</p>
                  </div>
                </Label>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <Label htmlFor="extensive" className="cursor-pointer flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Intégration maximale de solutions écologiques (+5,7%)</p>
                  </div>
                </Label>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center">
                ...
                <Label htmlFor="none" className="cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Pas de solutions écologiques spécifiques</p>
                </Label>
              </div>
            </CardContent>
          </Card>
