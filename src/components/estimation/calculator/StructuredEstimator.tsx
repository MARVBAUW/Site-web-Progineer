      ...
      default:
        ...
        return (
          <div className="p-4">
            ...
            <p className="text-sm text-low-contrast mt-2">Type de client: {formData.clientType}</p>
            <p className="text-sm text-low-contrast">Type de projet: {formData.projectType}</p>
          </div>
        );
    }
  };
