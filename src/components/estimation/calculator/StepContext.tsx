...
const StepContext: React.FC<StepContextProps> = ({ 
  ...
  return (
    <div className="md:col-span-1">
      ...
      <div className="mt-6 bg-card/90 backdrop-blur-sm rounded-lg p-4 border border-border shadow-sm">
        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Conseils pour cette étape</h3>
