...
const EstimationReport: React.FC<EstimationReportProps> = ({ 
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-300">Localisation:</span>
                  <span className="font-medium">{formData.city || 'Non spécifié'}</span>
                </div>
                {formData.bedrooms && (
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Chambres:</span>
                    <span className="font-medium">{formData.bedrooms}</span>
                  </div>
                )}
                {formData.bathrooms && (
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Salles de bain:</span>
                    <span className="font-medium">{formData.bathrooms}</span>
                  </div>
                )}
                {formData.constructionType && (
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Construction:</span>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-300">TVA (20%):</span>
                ...
                <div className="pt-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Honoraires MOE:</span>
                    <span>{formatCurrency(estimation.honorairesHT)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Taxe d'aménagement:</span>
                    <span>{formatCurrency(estimation.taxeAmenagement)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Garantie décennale:</span>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-300">Études géotechniques:</span>
              <span>{formatCurrency(estimation.etudesGeotechniques)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-300">Étude thermique:</span>
      ...
      <div className="bg-muted p-4 rounded-lg text-xs text-low-contrast">
