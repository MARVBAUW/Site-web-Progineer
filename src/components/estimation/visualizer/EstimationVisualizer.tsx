...
const EstimationVisualizer: React.FC<EstimationVisualizerProps> = ({ 
  ...
  return (
    <div className="hidden md:block bg-gradient-to-br from-white to-gray-100 dark:from-slate-800 dark:to-slate-700 rounded-lg p-6 shadow-inner h-60">
      ...
      <div className="h-40 w-full relative overflow-hidden bg-card/50 rounded-lg border border-border">
        <div className="relative h-full w-full">
          ...
          <div className="absolute top-2 right-2 bg-muted/80 px-2 py-0.5 rounded-full text-xs font-medium">
