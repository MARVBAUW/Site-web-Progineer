...
const EstimationFAQ = () => {
  return (
    <section className="py-16 bg-card">
      <Container size="md">
        <h3 className="text-2xl md:text-3xl font-rare tracking-wide mb-10 text-center text-progineer-gold">
          Questions fréquentes sur nos estimations
        </h3>
        
        <div className="space-y-6 max-w-3xl mx-auto">
          <div className="border-b border-progineer-gold/20 pb-4">
            <h4 className="text-xl font-medium mb-2 text-progineer-dark">Comment est calculée l'estimation de mon projet ?</h4>
          ...
          <div className="border-b border-progineer-gold/20 pb-4">
            <h4 className="text-xl font-medium mb-2 text-progineer-dark">Combien de temps faut-il pour recevoir mon estimation ?</h4>
          ...
          <div className="border-b border-progineer-gold/20 pb-4">
            <h4 className="text-xl font-medium mb-2 text-progineer-dark">L'estimation est-elle vraiment gratuite ?</h4>
          ...
          <div className="border-b border-progineer-gold/20 pb-4">
            <h4 className="text-xl font-medium mb-2 text-progineer-dark">Dans quelles villes intervenez-vous en PACA ?</h4>
