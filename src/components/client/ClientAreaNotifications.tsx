          ...
          {notifications.map((notification) => (
            <div 
              ...
              className={`flex p-3 rounded-lg border ${
                notification.read ? 'border-gray-100 bg-card' : 'border-khaki-100 bg-khaki-50'
              }`}
            >
              ...
              <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
                ...
                notification.type === 'payment' ? 'bg-red-100' : 'bg-muted'
              }`}>
              ...
              <div className="ml-3 flex-grow">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-xs text-low-contrast">{notification.date}</span>
                </div>
