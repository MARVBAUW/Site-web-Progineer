      ...
      <Card>
        ...
        <CardContent>
          <div className="py-8 text-center">
            <p className="text-low-contrast">Aucune donnée de planning disponible pour ce projet.</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      ...
      <CardContent>
          ...
          {phasesToDisplay.map((phase, index) => {
            ...
            return (
              <div key={index} className="relative h-10">
                <div className="absolute left-0 top-0 h-full w-full bg-muted rounded"></div>
                <div 
        ...
        <div className="mt-8 text-center text-sm text-low-contrast">
