    ...
    <Card>
      ...
      <CardContent>
        ...
        {currentStage && (
          <div className="bg-khaki-50 border border-khaki-100 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="font-medium text-gray-900 dark:text-white">Étape en cours : {currentStage.name}</h3>
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300">Dernières étapes complétées</h3>
            ...
            .map(stage => (
              <div key={stage.id} className="flex items-center p-3 border border-gray-100 rounded-lg">
                ...
                <div className="ml-3">
                  ...
                  <div className="text-xs text-low-contrast">Terminé le {stage.date}</div>
                </div>
              </div>
            ))
          }
          
          <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300 pt-2">Prochaines étapes</h3>
          ...
          {projectStages
            ...
            .map(stage => (
              <div key={stage.id} className="flex items-center p-3 border border-gray-100 rounded-lg">
                ...
                <div className="ml-3">
                  <div className="font-medium">{stage.name}</div>
                  <div className="text-xs text-low-contrast">{stage.date}</div>
                </div>
              </div>
            ))
          }
