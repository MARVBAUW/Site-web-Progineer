...
const MessageDisplay = ({ 
  ...
  return (
    <div className="md:col-span-2 bg-card rounded-xl border border-border overflow-hidden shadow-sm flex flex-col">
              ...
              <span className="ml-2 flex items-center">
                {conversation.contact.status === 'online' ? (
                  ...
                  <>
                    ...
                    <span className="text-low-contrast">Hors ligne</span>
                  </>
                )}
              </span>
            </div>
      ...
      <div className="flex-grow p-4 overflow-y-auto bg-muted/50">
          ...
          >
            ...
            <div className={`max-w-xs sm:max-w-md px-4 py-2 rounded-lg ${
              ...
              <div className={`text-xs mt-1 ${
                message.sender === 'me' ? 'text-khaki-100' : 'text-low-contrast'
              }`}>
                {message.date}
              </div>
            </div>
