      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-low-contrast">Recevez des notifications par email concernant votre projet.</p>
          </div>
          <Switch 
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-low-contrast">Recevez des notifications par SMS pour les mises à jour importantes.</p>
          </div>
          <Switch 
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-low-contrast">Recevez des notifications lorsque de nouveaux documents sont disponibles.</p>
          </div>
          <Switch 
