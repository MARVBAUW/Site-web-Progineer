          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-low-contrast">Nom complet</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-low-contrast">Email</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-low-contrast">Téléphone</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-low-contrast">Société</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-low-contrast">Adresse</p>
