      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-4 mt-2">
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="hasPool" {...register("hasPool")} className="h-4 w-4 rounded border-border" />
            <Label htmlFor="hasPool" className="font-normal">Piscine</Label>
          </div>
          
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="hasSolarPanels" {...register("hasSolarPanels")} className="h-4 w-4 rounded border-border" />
            <Label htmlFor="hasSolarPanels" className="font-normal">Panneaux solaires</Label>
          </div>
          
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="hasGarage" {...register("hasGarage")} className="h-4 w-4 rounded border-border" />
            <Label htmlFor="hasGarage" className="font-normal">Garage</Label>
          </div>
          
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="hasBasement" {...register("hasBasement")} className="h-4 w-4 rounded border-border" />
