      ...
      <Container>
        ...
        <div className="relative max-w-2xl mx-auto mb-12">
          ...
          <input
            ...
            className="w-full py-3 pl-12 pr-4 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-khaki-600 focus:border-transparent"
            value={searchTerm}
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full transition-colors ${
              activeCategory === null 
                ...
                : 'bg-muted text-gray-600 dark:text-gray-300 hover:bg-gray-200'
            }`}
          >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {filteredItems.length === 0 ? (
            <div className="text-center py-10">
              <p className="text-gray-600 dark:text-gray-300">Aucun résultat trouvé pour votre recherche.</p>
              <button 
            ...
            <div className="space-y-6">
              {filteredItems.map((item) => (
                <div 
                  key={item.id} 
                  id={item.id}
                  className="bg-card p-6 rounded-lg shadow-sm border border-gray-100"
                >
