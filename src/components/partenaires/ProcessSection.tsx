    ...
    <section className="py-16">
      <Container>
        <div className="text-center mb-16">
          <h2 className="text-3xl font-semibold mb-4 text-gray-900 dark:text-white">Comment ça fonctionne ?
          </h2>
...
const ProcessStep = ({ number, title, description }: ProcessStepProps) => (
  <div className="bg-card rounded-xl p-6 shadow-sm border border-border text-center relative">
