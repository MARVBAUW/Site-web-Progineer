      ...
      <section className="bg-khaki-50 p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-6 rounded-lg shadow-sm">
            ...
            <ul className="ml-8 space-y-2 list-disc text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600 dark:text-gray-300">Qualité irréprochable des prestations</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Respect des délais et engagements</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Transparence et communication proactive</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Professionnalisme avec les clients</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Assurances et garanties à jour</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600 dark:text-gray-300">Apport régulier de nouveaux projets</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Dossiers techniques complets et détaillés</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Support technique et coordination</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Visibilité sur notre site web et supports marketing</span>
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 p-1 rounded-full mr-3 mt-1">
                  <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600 dark:text-gray-300">Paiements respectant les délais convenus</span>
              </li>
            </ul>
          </div>
        </div>
