  ...
  return (
    <div className="py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Qui peut devenir partenaire ?</h2>
          ...
          <Card className="p-6">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-xs text-low-contrast text-center mt-2">
