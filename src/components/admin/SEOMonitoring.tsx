        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Total issues</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">{duplicateTitles}</div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Duplicate titles</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">{duplicateDescriptions}</div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Duplicate descriptions</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">{pagesWithMissingH1}</div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Missing H1 tags</p>
            </CardContent>
          </Card>
        </div>
