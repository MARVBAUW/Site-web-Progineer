  ...
  return (
    <Card className="border-border shadow-sm">
      <CardHeader className="pb-3 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="flex items-start justify-between">
          <div>
            ...
            <CardDescription className="mt-1 dark:text-gray-600 dark:text-gray-300">
          ...
          <Badge 
            ...
            className={status === 'success' ? "bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-400" : 
                      ...
                      "bg-muted/50 text-gray-700 dark:bg-gray-800 dark:text-gray-600 dark:text-gray-300"}
          >
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="mt-4 pt-4 border-t border-border text-sm text-low-contrast">
