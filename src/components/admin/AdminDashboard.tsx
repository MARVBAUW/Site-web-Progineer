      ...
      <div className="bg-gradient-to-r from-khaki-100/70 to-khaki-50/70 p-6 rounded-xl border border-khaki-200/50 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
            <Button asChild variant="outline" className="border-khaki-200 hover:bg-khaki-50 text-gray-600 dark:text-gray-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        <Card className="bg-card">
          <CardContent className="pt-6">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm font-medium text-low-contrast">Clients</p>
        ...
        <Card className="bg-card">
          <CardContent className="pt-6">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm font-medium text-low-contrast">Projets</p>
        ...
        <Card className="bg-card">
          <CardContent className="pt-6">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm font-medium text-low-contrast">Tâches en attente</p>
        ...
        <Card className="bg-card">
          <CardContent className="pt-6">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm font-medium text-low-contrast">Documents</p>
                  ...
                  <div className="space-y-4">
                    <div className="p-3 rounded-lg bg-khaki-50 border border-khaki-100 flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">Mis à jour le 02/04/2023</p>
                      </div>
                    ...
                    <div className="p-3 rounded-lg bg-khaki-50 border border-khaki-100 flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">Mis à jour le 28/03/2023</p>
                      </div>
                    ...
                    <div className="p-3 rounded-lg bg-khaki-50 border border-khaki-100 flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">Mis à jour le 25/03/2023</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-3 rounded-lg bg-amber-50 border border-amber-100 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">Aujourd'hui à 14:00</p>
                      </div>
                    </div>
                    <div className="p-3 rounded-lg bg-khaki-50 border border-khaki-100 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">Demain à 18:00</p>
                      </div>
                    </div>
                    <div className="p-3 rounded-lg bg-blue-50 border border-blue-100 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-low-contrast">07/04/2023 à 10:30</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
