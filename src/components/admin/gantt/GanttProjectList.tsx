  ...
  return (
    <>
      {displayProjects.map((project, projectIndex) => (
        <div key={projectIndex} className="border-b border-gray-100 dark:border-gray-700 hover:bg-muted/50 transition-colors">
          <div className="flex">
            <div className="w-[200px] shrink-0 p-3 font-medium">
              <div className="text-gray-900 dark:text-white">{project.projectName}</div>
              <div className="text-xs text-low-contrast">{project.fileNumber}</div>
