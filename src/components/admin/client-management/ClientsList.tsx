  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex border-b border-border">
        <button
          className={`px-4 py-2 font-medium text-sm ${activeTab === 'all' ? 'border-b-2 border-khaki-600 text-khaki-800' : 'text-low-contrast hover:text-gray-600 dark:text-gray-300'}`}
          onClick={() => setActiveTab('all')}
        >
          Tous les clients
        </button>
        <button
          className={`px-4 py-2 font-medium text-sm ${activeTab === 'withProject' ? 'border-b-2 border-khaki-600 text-khaki-800' : 'text-low-contrast hover:text-gray-600 dark:text-gray-300'}`}
          onClick={() => setActiveTab('withProject')}
        >
          Avec projet
        </button>
        <button
          className={`px-4 py-2 font-medium text-sm ${activeTab === 'withoutProject' ? 'border-b-2 border-khaki-600 text-khaki-800' : 'text-low-contrast hover:text-gray-600 dark:text-gray-300'}`}
