        ...
        <Tabs defaultValue="profile" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="meetings" className="m-0 pt-6">
            <div className="space-y-4">
              ...
              <p className="text-low-contrast">Aucune réunion n'est actuellement planifiée avec ce client.</p>
          ...
          <TabsContent value="payments" className="m-0 pt-6">
            <div className="space-y-4">
              ...
              <p className="text-low-contrast">Aucun paiement n'a encore été enregistré pour ce client.</p>
              {/* Component placeholder for future development */}
            </div>
          </TabsContent>
          ...
          <TabsContent value="messages" className="m-0 pt-6">
            <div className="space-y-4">
              ...
              <p className="text-low-contrast">Aucun message n'a été échangé avec ce client.</p>
              {/* Component placeholder for future development */}
            </div>
          </TabsContent>
        </Tabs>
