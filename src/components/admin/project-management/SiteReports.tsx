                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {companies.length > 0 ? (
                            ...
                            <p className="text-sm text-low-contrast col-span-2">
      ...
      <CardContent>
        {reports.length > 0 ? (
          <div className="space-y-4">
            {reports.map((report) => (
              <div key={report.id} className="border rounded-lg p-4 bg-muted/50">
                <div className="flex justify-between mb-3">
                  ...
                  {!readOnly && (
                    <div className="flex">
                      ...
                      >
                        <Edit className="h-4 w-4 text-low-contrast" />
                      </Button>
                      <Button 
                        variant="ghost" 
                        size="sm" 
                ...
                {report.content && (
                  <div className="mb-3 text-sm bg-card p-3 border rounded">
                    {report.content}
                  </div>
                )}
                ...
                {report.companies && report.companies.length > 0 && (
                  <div className="mb-3">
                    <p className="text-xs font-medium text-low-contrast mb-1">Entreprises présentes:</p>
                ...
                {report.photos && report.photos.length > 0 && (
                  <div>
                    <p className="text-xs font-medium text-low-contrast mb-1 flex items-center">
          ...
          <div className="text-center py-6">
            <p className="text-low-contrast">Aucun compte-rendu n'est disponible pour le moment.</p>
            {!readOnly && (
              <Button 
