        ...
        <div className="bg-muted px-4 py-3 flex items-center justify-between border-b">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="p-1.5 rounded-md text-low-contrast hover:text-gray-600 dark:text-gray-300 hover:bg-gray-200"
            >
        ...
        <div className="flex border-b border-border">
          <button 
            ...
            className={`px-4 py-2 text-sm font-medium ${
              currentTab === 'aperçu' ? 'border-b-2 border-khaki-500 text-khaki-700' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white'
            }`}
          >
            Aperçu
          </button>
          <button 
            ...
            className={`px-4 py-2 text-sm font-medium ${
              currentTab === 'propriétés' ? 'border-b-2 border-khaki-500 text-khaki-700' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white'
            }`}
          >
            Propriétés
          </button>
