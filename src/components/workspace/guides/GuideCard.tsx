  ...
  return (
    ...
    >
      <CardContent className="p-6">
        ...
        <p className="text-sm text-low-contrast mb-3 line-clamp-2">{document.description}</p>
        <div className="flex justify-between items-center text-xs text-low-contrast">
