      ...
      <Card>
        <CardContent className="p-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-low-contrast">Guides PDF</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-low-contrast">Tutoriels vidéo</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-low-contrast">Dernière mise à jour</p>
          </div>
        </CardContent>
      </Card>
    </div>
