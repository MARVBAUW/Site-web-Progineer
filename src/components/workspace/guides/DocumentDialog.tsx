...
export const DocumentDialog: React.FC<DocumentDialogProps> = ({
  ...
  const getDocumentIcon = () => {
    switch (selectedDocument.type) {
      case 'video': return <Video className="h-16 w-16 text-gray-600 dark:text-gray-300" />;
      case 'text': 
      case 'pdf':
      default: return <FileText className="h-16 w-16 text-gray-600 dark:text-gray-300" />;
    }
  };
