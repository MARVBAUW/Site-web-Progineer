        ...
        <Tabs defaultValue="manuel">
          ...
          <TabsContent value="recherche" className="space-y-4 pt-4">
            ...
            <div className="text-center p-4 border border-dashed rounded-md">
              <Upload className="h-10 w-10 mx-auto text-gray-600 dark:text-gray-300 mb-2" />
              ...
              <div className="p-4 bg-muted rounded-md mt-4">
                ...
                <div className="mt-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="p-2 bg-card rounded">Isolation des combles: économie potentielle de 15%</li>
                    <li className="p-2 bg-card rounded">Remplacement des fenêtres: économie potentielle de 10%</li>
                    <li className="p-2 bg-card rounded">Installation d'une pompe à chaleur: économie potentielle de 25%</li>
                  </ul>
                </div>
              </div>
            )}
