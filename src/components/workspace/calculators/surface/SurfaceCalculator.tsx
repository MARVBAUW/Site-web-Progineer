          ...
          <TabsContent value="calculator">
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="space-y-4">
                  {rooms.map((room) => (
                    <div key={room.id} className="p-4 border rounded-lg bg-muted/50">
                      <div className="flex justify-between items-center mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-sm text-low-contrast">
                            {room.area} m²
                          </span>
                        </div>
                        <Button 
                        ...
                        >
                          <Trash2 className="h-4 w-4 text-low-contrast" />
                        </Button>
                      </div>
              ...
              <div className="border p-4 rounded-lg mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-300">Surface habitable + surfaces annexes pondérées (caves, garages, etc.)</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium">Surface de plancher</p>
                    <p className="text-xs text-gray-600 dark:text-gray-300">A remplacé la SHON depuis 2012 pour les demandes d'autorisation d'urbanisme</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium">Surface Carrez</p>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Utilisée pour la vente de lots en copropriété, mesurée à l'intérieur des murs</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium">Surface pondérée</p>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Attribue des coefficients de pondération aux différentes pièces selon leur usage</p>
                  </div>
                </div>
              </div>
