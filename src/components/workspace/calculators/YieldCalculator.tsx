          ...
          <div className="bg-muted/50 p-4 rounded-md border border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-3 bg-card rounded-md border">
                <div className="text-sm text-low-contrast">Rendement brut</div>
                <div className="text-2xl font-bold text-khaki-700">{results.grossYield.toFixed(2)}%</div>
              </div>
              
              <div className="p-3 bg-card rounded-md border">
                <div className="text-sm text-low-contrast">Rendement net</div>
                <div className="text-2xl font-bold text-khaki-700">{results.netYield.toFixed(2)}%</div>
              </div>
              
              <div className="p-3 bg-card rounded-md border">
                <div className="text-sm text-low-contrast">Cash-on-Cash</div>
