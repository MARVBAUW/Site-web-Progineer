            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-low-contrast mt-1">Nécessaire pour calculer le taux d'endettement</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-low-contrast mt-1">Généralement limité à 35% par les banques</p>
                </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <div className="text-sm text-low-contrast">Mensualité</div>
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <div className="text-sm text-low-contrast">Coût total du crédit</div>
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <div className="text-sm text-low-contrast">Taux d'endettement</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-low-contrast mb-4">
          ...
          <TabsContent value="results" className="space-y-6">
            {hasCalculated ? (
              <>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-base flex items-center gap-2">
                        <Wallet className="h-4 w-4 text-low-contrast" />
                        Mensualité
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-base flex items-center gap-2">
                        <TrendingDown className="h-4 w-4 text-low-contrast" />
                        Taux d'endettement
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-low-contrast max-w-md mx-auto mb-6">
            ...
            {hasCalculated && results.amortizationTable.length > 0 ? (
              <>
                <div className="bg-muted/50 p-4 rounded-lg mb-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <div className="text-sm text-low-contrast">Prêt</div>
                      <div className="text-lg font-medium">{loanData.loanAmount.toLocaleString('fr-FR')} €</div>
                    </div>
                    ...
                    <div>
                      <div className="text-sm text-low-contrast">Périodicité</div>
