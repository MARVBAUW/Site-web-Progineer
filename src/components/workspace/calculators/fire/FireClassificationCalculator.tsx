              ...
              <div className="space-y-4">
                <div className="rounded-md border p-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm text-low-contrast">Type d'établissement</p>
                      <p className="text-lg font-medium">Type {erpType} - {getErpTypeDescription()}</p>
                    </div>
                    <div>
                      <p className="text-sm text-low-contrast">Catégorie</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="rounded-md border p-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm text-low-contrast">Famille d'habitation</p>
                      <p className="text-lg font-medium">{determineHabitationFamily()}</p>
                    </div>
                    
                    {habitationType && (
                      <div>
                        <p className="text-sm text-low-contrast">Type d'habitation</p>
