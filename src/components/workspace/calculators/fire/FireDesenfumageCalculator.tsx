            ...
            <div className="rounded-md border p-4 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Surface utile d'évacuation</p>
                  <p className="text-lg font-medium">{calculateSmokeSurface()} m²</p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Nombre d'exutoires requis</p>
                  <p className="text-lg font-medium">{calculateExutoires()}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Surface d'amenée d'air</p>
