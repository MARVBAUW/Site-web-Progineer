        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <div className="rounded-md border p-4 mt-4 bg-slate-50">
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Distance maximale à parcourir jusqu'à une sortie</p>
          ...
          <TabsContent value="exit_width" className="space-y-4">
            ...
            <div className="rounded-md border p-4 mt-4 bg-slate-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Unités de passage requises</p>
                  <p className="text-2xl font-semibold">{calculatePassageUnits()} UP</p>
                  <p className="text-xs text-low-contrast">1 UP = 0,6 mètre</p>
                </div>
                
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Largeur minimale totale</p>
                  <p className="text-2xl font-semibold">{calculateMinWidth().toFixed(2)} m</p>
                </div>
                
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Largeur par sortie</p>
                  <p className="text-2xl font-semibold">{calculateWidthPerExit().toFixed(2)} m</p>
                </div>
                
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Conformité</p>
