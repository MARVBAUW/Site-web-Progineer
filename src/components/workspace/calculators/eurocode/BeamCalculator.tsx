                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      max="20"
                    />
                    <div className="w-[60px] text-sm text-low-contrast">m</div>
                  </div>
                </div>
              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Hauteur utile d:</span>
                        <span className="font-medium">{results.d.toFixed(1)} cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Bras de levier z:</span>
                        <span className="font-medium">{results.z.toFixed(1)} cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Moment réduit μ:</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Section d'acier minimale:</span>
