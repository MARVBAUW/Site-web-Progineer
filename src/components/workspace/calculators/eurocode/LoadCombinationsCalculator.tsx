  ...
  return (
    <div className="space-y-6">
      <div className="bg-muted/50 p-4 rounded-lg border border-border mb-6">
        <h3 className="text-gray-900 dark:text-white font-medium mb-2">Combinaisons de charges (Eurocode 0)</h3>
                  ...
                  <div className="space-y-4">
                    {results.combinations.map((combination: any, index: number) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-low-contrast">Formule: {combination.formula}</p>
                      </div>
                    ))}
                  </div>
                </div>
