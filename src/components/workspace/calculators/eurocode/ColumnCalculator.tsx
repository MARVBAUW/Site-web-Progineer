              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Hauteur:</span>
                        <span className="font-medium">{columnHeight} cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Élancement:</span>
                        <span className="font-medium">{results.slendernessRatio.toFixed(1)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Effets du flambement:</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Section d'acier nécessaire:</span>
                        <span className="font-medium">{results.requiredReinforcement.toFixed(2)} cm²</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Taux d'armatures:</span>
                        <span className="font-medium">{results.reinforcementRatio.toFixed(2)}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Section minimale:</span>
                        <span className="font-medium">{results.minReinforcement.toFixed(2)} cm²</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Section maximale:</span>
                        <span className="font-medium">{results.maxReinforcement.toFixed(2)} cm²</span>
                      </div>
                      <Separator className="my-2" />
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Configuration proposée:</span>
