              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Type de dalle:</span>
                        <span className="font-medium">
                          {slabType === 'one-way' ? 'Unidirectionnelle' : 'Bidirectionnelle'}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Charge totale (ELS):</span>
                        <span className="font-medium">{results.totalLoad.toFixed(2)} kN/m²</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Charge de calcul (ELU):</span>
                        <span className="font-medium">{results.designLoad.toFixed(2)} kN/m²</span>
                      </div>
                      <Separator className="my-2" />
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Moment en X:</span>
                        <span className="font-medium">{results.momentX.toFixed(2)} kN.m/m</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Moment en Y:</span>
                        <span className="font-medium">{results.momentY.toFixed(2)} kN.m/m</span>
                      </div>
                      <Separator className="my-2" />
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Flèche estimée:</span>
                        <span className="font-medium">{results.deflection.toFixed(1)} mm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Ratio flèche/portée:</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Armatures en X:</span>
                        <span className="font-medium">{results.reinforcementX.toFixed(2)} cm²/m</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Armatures en Y:</span>
                        <span className="font-medium">{results.reinforcementY.toFixed(2)} cm²/m</span>
                      </div>
                      <Separator className="my-2" />
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Barres principales:</span>
                        <span className="font-medium">
                          HA{results.primaryBarDiameter} @ {results.primaryBarSpacing} cm
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Barres secondaires:</span>
                        <span className="font-medium">
