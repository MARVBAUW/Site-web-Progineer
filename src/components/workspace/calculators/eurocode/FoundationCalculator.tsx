...
const FoundationCalculator = () => {
  ...
  return (
    <Card className="shadow-md">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      max="500"
                    />
                    <div className="w-[60px] text-sm text-low-contrast">cm</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      min="0"
                    />
                    <div className="w-[60px] text-sm text-low-contrast">kN</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      min="0"
                    />
                    <div className="w-[60px] text-sm text-low-contrast">kN.m</div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Capacité portante du sol:</span>
                        <span className="font-medium">{results.bearingCapacity.toFixed(1)} kPa</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Charge limite:</span>
                        <span className="font-medium">{results.ultimateLoad.toFixed(1)} kN</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Facteur de sécurité:</span>
                        <span className={`font-medium ${results.safetyFactor < 1.5 ? "text-red-600" : "text-green-600"}`}>
                          {results.safetyFactor.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Tassement estimé:</span>
                        <span className="font-medium">{results.settlement.toFixed(1)} mm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Taux d'utilisation:</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Excentricité:</span>
                        <span className="font-medium">{results.eccentricity.toFixed(1)} cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Surface effective:</span>
                        <span className="font-medium">{results.effectiveArea.toFixed(2)} m²</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Contrainte au sol:</span>
                        <span className="font-medium">{results.soilPressure.toFixed(1)} kPa</span>
                      </div>
                      <Separator className="my-2" />
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Épaisseur recommandée:</span>
                        <span className="font-medium">{results.baseThickness.toFixed(0)} cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-300">Armatures principales:</span>
          ...
          <TabsContent value="help">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <ol className="text-sm space-y-1 text-gray-600 dark:text-gray-300 list-decimal pl-4">
              ...
              <div className="space-y-2">
                ...
                <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-300 list-disc pl-4">
      ...
      <CardFooter className="justify-between border-t pt-4 text-xs text-low-contrast">
        <div>
