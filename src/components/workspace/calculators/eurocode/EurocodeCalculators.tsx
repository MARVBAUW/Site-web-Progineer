  ...
  return (
    <div className="space-y-4">
      <div className="mb-4">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-sm">Suite d'outils de calcul conformes aux Eurocodes pour les ingénieurs et professionnels de la construction.</p>
      </div>
