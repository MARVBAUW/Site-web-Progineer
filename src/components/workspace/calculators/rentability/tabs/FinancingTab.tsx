    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-low-contrast mt-1">Pourcentage du capital emprunté (annuel)</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-low-contrast mt-1">Estimation de l'évolution de la valeur du bien</p>
          </div>
      ...
      <div className="bg-muted/50 p-4 rounded-lg">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <div className="text-sm text-low-contrast">Investissement total</div>
          ...
          <div>
            <div className="text-sm text-low-contrast">Apport personnel</div>
            <div className="text-lg font-semibold">{remainingAmount.toLocaleString('fr-FR')} €</div>
          </div>
          <div>
            <div className="text-sm text-low-contrast">Pourcentage financé</div>
