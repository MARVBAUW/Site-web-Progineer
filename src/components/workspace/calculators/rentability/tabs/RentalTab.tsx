    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-low-contrast mt-1">Estimation du pourcentage de temps où le bien sera vacant</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-low-contrast mt-1">Estimation du risque d'impayés locatifs</p>
        </div>
