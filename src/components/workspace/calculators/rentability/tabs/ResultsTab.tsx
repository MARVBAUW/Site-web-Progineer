  ...
  if (!hasCalculated) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <h3 className="text-xl font-medium text-gray-600 dark:text-gray-300 mb-2">Pas encore de résultats</h3>
        <p className="text-low-contrast mb-6 text-center max-w-md">
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">Rendement brut</div>
        ...
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">Rendement net</div>
          <div className="flex items-center">
        ...
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">Cash flow mensuel</div>
          <div className="flex items-center">
        ...
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">Cash on Cash</div>
          <div className="flex items-center">
        ...
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">TRI sur 10 ans</div>
          <div className="flex items-center">
        ...
        <div className="bg-card p-4 border border-border rounded-lg">
          <div className="text-sm text-low-contrast mb-1">Durée d'amortissement</div>
          <div className="flex items-center">
