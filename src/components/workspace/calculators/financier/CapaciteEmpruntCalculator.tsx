          ...
          <TabsContent value="results" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-primary/10 p-4 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Capacité d'emprunt</p>
                <p className="text-2xl font-semibold">{calculation.maxLoanAmount.toLocaleString('fr-FR')} €</p>
              </div>
              
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Budget total (avec apport)</p>
                <p className="text-2xl font-semibold">{totalBudget.toLocaleString('fr-FR')} €</p>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Mensualité estimée</p>
                <p className="text-2xl font-semibold">{calculation.monthlyPayment.toLocaleString('fr-FR')} €</p>
              </div>
              
              <div className="bg-orange-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Coût total des intérêts</p>
