                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="bg-khaki-50 p-4 rounded-lg space-y-1">
                        <div className="text-sm text-low-contrast">Surface brute totale</div>
                        <div className="text-3xl font-bold">{totalSurface} m²</div>
                      </div>
                      <div className="bg-green-50 p-4 rounded-lg space-y-1">
                        <div className="text-sm text-low-contrast">Surface habitable</div>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg space-y-1">
                        <div className="text-sm text-low-contrast">Surface Loi Carrez</div>
