        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <div className="rounded-md border p-4 mt-4 bg-slate-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Indice d'affaiblissement acoustique Rw</p>
                  <p className="text-2xl font-semibold">{rwValue} dB</p>
                </div>
                
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Isolation acoustique standardisée DnT,A</p>
          ...
          <TabsContent value="reverberation" className="space-y-4">
            ...
            <div className="rounded-md border p-4 mt-4 bg-slate-50">
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Temps de réverbération (Sabine)</p>
                ...
                <div className="space-y-1">
                  <p className="text-sm text-low-contrast">Volume de la pièce</p>
