...
const LoanComparisonCalculator = () => {
  ...
  const getKPIColor = (value: number, lowerIsBetter: boolean = true, results: ComparisonResult[] = comparisonResults) => {
    if (results.length === 0) return 'text-gray-600 dark:text-gray-300';
          ...
          <TabsContent value="input" className="space-y-6">
            <div>
              ...
              {loans.map((loan, index) => (
                <Card key={index} className="mb-6 p-4 border border-border">
                  <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="mb-2"
                      />
                      <p className="text-xs text-low-contrast mb-4">Montant du capital emprunté en euros</p>
                      ...
                      <Input
                        ...
                        className="mb-2"
                      />
                      <p className="text-xs text-low-contrast">Frais bancaires, courtage, garanties...</p>
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="mb-2"
                      />
                      <p className="text-xs text-low-contrast mb-4">Taux nominal annuel (hors assurance)</p>
                      ...
                      <Input
                        ...
                        className="mb-2"
                      />
                      <p className="text-xs text-low-contrast mb-4">Durée totale du prêt en années</p>
                      ...
                      <Input
                        ...
                        className="mb-2"
                      />
                      <p className="text-xs text-low-contrast">Taux annuel sur le capital emprunté</p>
                    </div>
                    ...
                    {showAdvanced && (
                      <div>
                        ...
                        <p className="text-xs text-low-contrast mb-4">Mode de calcul des remboursements</p>
                        ...
                        <Input
                          ...
                          className="mb-2"
                        />
                        <p className="text-xs text-low-contrast">Période de différé d'amortissement</p>
                      </div>
                    )}
                  </div>
                </Card>
                          ...
                          <CardContent>
                            <div className="space-y-2">
                              <div className="grid grid-cols-2 gap-1">
                                <div className="text-sm text-low-contrast">Montant</div>
                                <div className="text-sm font-medium text-right">{loan.amount.toLocaleString('fr-FR')} €</div>
                              </div>
                              <div className="grid grid-cols-2 gap-1">
                                <div className="text-sm text-low-contrast">Taux nominal</div>
                                <div className="text-sm font-medium text-right">{loan.rate.toFixed(2)} %</div>
                              </div>
                              <div className="grid grid-cols-2 gap-1">
                                <div className="text-sm text-low-contrast">Durée</div>
                              ...
                              <div className="grid grid-cols-2 gap-1">
                                <div className="text-sm text-low-contrast">Coût total</div>
