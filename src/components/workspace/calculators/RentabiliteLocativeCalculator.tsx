          ...
          <TabsContent value="results" className="space-y-6 pt-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  <h4 className="text-sm font-medium text-gray-600 dark:text-gray-300">Investissement total</h4>
                  <p className="text-xl font-semibold">{(prixAchat + fraisNotaire + travaux).toLocaleString('fr-FR')} €</p>
                </div>
                
                <div>
                  <h4 className="text-sm font-medium text-gray-600 dark:text-gray-300">Revenus annuels</h4>
                  <p className="text-xl font-semibold">{(loyerMensuel * 12).toLocaleString('fr-FR')} €</p>
                </div>
                
                <div>
                  <h4 className="text-sm font-medium text-gray-600 dark:text-gray-300">Charges annuelles</h4>
                  <p className="text-xl font-semibold">{chargesAnnuelles.toLocaleString('fr-FR')} €</p>
                </div>
                
                <div>
                  <h4 className="text-sm font-medium text-gray-600 dark:text-gray-300">Revenus nets</h4>
