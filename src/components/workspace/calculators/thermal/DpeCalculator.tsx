            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="text-center">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Consommation énergétique</p>
                  <div 
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Émissions de GES</p>
                  <div 
                    className="text-4xl font-bold rounded-full w-20 h-20 mx-auto flex items-center justify-center text-white"
