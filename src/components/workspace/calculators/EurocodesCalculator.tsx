              ...
              <div className="bg-muted/50 p-4 rounded-md border border-border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-3 bg-card rounded-md border">
                    <div className="text-sm text-low-contrast">Coefficient U</div>
                    <div className="text-2xl font-bold text-khaki-700">{thermalResults.uValue.toFixed(2)} W/m²K</div>
                  </div>
                  
                  <div className="p-3 bg-card rounded-md border">
                    <div className="text-sm text-low-contrast">Résistance thermique</div>
                    <div className="text-2xl font-bold text-khaki-700">{thermalResults.totalR.toFixed(2)} m²K/W</div>
                  </div>
                  
                  <div className="p-3 bg-card rounded-md border">
                    <div className="text-sm text-low-contrast">Classe énergétique</div>
              ...
              {dpeResults && (
                <div className="bg-muted/50 p-4 rounded-md border border-border">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Référence</div>
                      <div className="font-medium">{dpeResults.reference}</div>
                    </div>
                    
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Adresse</div>
                      <div className="font-medium">{dpeResults.address}</div>
                    </div>
                    
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Type de bâtiment</div>
                      <div className="font-medium">{dpeResults.buildingType}</div>
                    </div>
                    
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Année de construction</div>
                      <div className="font-medium">{dpeResults.constructionYear}</div>
                    </div>
                    
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Surface</div>
                      <div className="font-medium">{dpeResults.surfaceArea} m²</div>
                    </div>
                    
                    <div>
                      <div className="text-sm text-low-contrast mb-1">Validité</div>
                      <div className="font-medium">Jusqu'au {dpeResults.validUntil}</div>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 mb-6">
                    <div className={`flex-1 p-3 rounded-md border text-center bg-card`}>
                      <div className="text-sm text-low-contrast mb-1">Classe énergie</div>
                      ...
                      <div className="text-xs text-low-contrast">{dpeResults.energyConsumption} kWh/m²/an</div>
                    </div>
                    
                    <div className={`flex-1 p-3 rounded-md border text-center bg-card`}>
                      <div className="text-sm text-low-contrast mb-1">Émissions GES</div>
                      <div className="text-2xl font-bold" style={{color: 
                      ...
                      <div className="text-xs text-low-contrast">{dpeResults.ghgEmissions} kg CO₂e/m²/an</div>
                    </div>
                  </div>
                      ...
                      <div key={index} className="bg-card p-3 rounded-md border">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-1 text-sm">
                            <span className="text-low-contrast">Nouvelle classe :</span>
                        ...
                        <div className="flex justify-between mt-3 text-sm">
                          <div>
                            <span className="text-low-contrast">Coût estimé :</span>
                            <span className="font-medium ml-1">{option.cost} €</span>
                          </div>
                          <div>
                            <span className="text-low-contrast">Économies :</span>
