    ...
    <>
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="mb-6">
          ...
          {/* Resource details */}
          <div className="bg-muted/50 border border-gray-100 rounded-lg p-6 mb-8">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {resource.keywords.map((keyword, i) => (
                    <span 
                      key={i}
                      className="bg-muted text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-sm"
                    >
                      {keyword}
                    </span>
                  ))}
                ...
                {resource.relatedResources.map((related, i) => (
                  <Card key={i} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-4">
                      ...
                      {related.description && (
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{related.description}</p>
                      )}
                      <Link 
                        to={related.url}
