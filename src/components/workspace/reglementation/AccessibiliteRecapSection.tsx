    ...
    <div className="space-y-6">
      ...
      <Tabs value={accessibiliteTab} onValueChange={setAccessibiliteTab} className="mt-6">
        <TabsList className="mb-6 bg-blue-50 flex flex-wrap">
          ...
          <TabsTrigger value="dimensions" className="data-[state=active]:bg-card">
            <Ruler className="h-4 w-4 mr-2" />
            <span>Règles dimensionnelles</span>
          </TabsTrigger>
          <TabsTrigger value="adap" className="data-[state=active]:bg-card">
            <CalendarDays className="h-4 w-4 mr-2" />
            <span>Agenda Ad'AP</span>
          </TabsTrigger>
          <TabsTrigger value="specifiques" className="data-[state=active]:bg-card">
