        ...
        <div className="space-y-6">
          ...
          <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card p-4 rounded-lg shadow-sm border border-indigo-100">
                <p className="text-sm text-low-contrast">Isolement standardisé DnT,A</p>
                <p className="text-3xl font-bold text-indigo-600">{calculateIsolement()} dB</p>
              </div>
              <div className="bg-card p-4 rounded-lg shadow-sm border border-indigo-100">
                <p className="text-sm text-low-contrast">Exigence réglementaire</p>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card p-4 rounded-lg shadow-sm border border-indigo-100">
                <p className="text-sm text-low-contrast">Niveau de bruit d'impact L'nT,w</p>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card p-4 rounded-lg shadow-sm border border-indigo-100">
                <p className="text-sm text-low-contrast">Temps de réverbération Tr</p>
                <p className="text-3xl font-bold text-indigo-600">{calculateReverberation()} s</p>
              </div>
              <div className="bg-card p-4 rounded-lg shadow-sm border border-indigo-100">
                <p className="text-sm text-low-contrast">Valeur cible</p>
    ...
    <div className="space-y-6">
      ...
      <Tabs value={acoustiqueTab} onValueChange={setAcoustiqueTab} className="mt-6">
        <TabsList className="mb-6 bg-indigo-50">
          <TabsTrigger value="logement" className="data-[state=active]:bg-card">
            <Home className="h-4 w-4 mr-2" />
            <span>Logement</span>
          </TabsTrigger>
          <TabsTrigger value="erp" className="data-[state=active]:bg-card">
          ...
          <TabsTrigger value="bureau" className="data-[state=active]:bg-card">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Calcul d'isolement entre locaux</p>
                  ...
                  <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Calcul niveau de bruit d'impact</p>
                    <div className="mt-2 flex gap-2">
                      <Button 
                        size="sm" 
                        variant="outline"
                  ...
                  <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Calcul de réverbération d'un local</p>
                    <div className="mt-2 flex gap-2">
                      <Button 
                        size="sm" 
                        variant="outline"
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">{dtu.description}</p>
                        </div>
