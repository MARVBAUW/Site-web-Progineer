            ...
            <CardContent className="space-y-4">
              {buildingClassificationsDTUs.map((dtu) => (
                <div key={dtu.id} className="border rounded-md p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">{dtu.description}</p>
              ...
              <div className="bg-blue-50 p-4 rounded-md border border-blue-100">
                ...
                <div className="flex justify-end mt-2">
                  <Link to="/workspace/calculateurs?tab=incendie">
                    <Button size="sm" variant="outline" className="text-xs bg-card text-blue-600 border-blue-200 hover:bg-blue-50">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-orange-50 p-4 rounded-md border border-orange-100">
                ...
                <div className="flex justify-end mt-2">
                  <Link to="/workspace/calculateurs?tab=incendie">
                    <Button size="sm" variant="outline" className="text-xs bg-card text-orange-600 border-orange-200 hover:bg-orange-50">
