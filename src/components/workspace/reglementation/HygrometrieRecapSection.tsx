    ...
    <div className="space-y-6">
      ...
      <Tabs value={hygrometrieTab} onValueChange={setHygrometrieTab} className="mt-6">
        <TabsList className="mb-6 bg-blue-50">
          ...
          <TabsTrigger value="condensation" className="data-[state=active]:bg-card">
            <Droplets className="h-4 w-4 mr-2" />
            <span>Condensation</span>
          </TabsTrigger>
          <TabsTrigger value="ventilation" className="data-[state=active]:bg-card">
        ...
        <TabsContent value="calculateurs" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-card p-6 rounded-lg border border-blue-100 shadow-sm">
              <h3 className="text-lg font-medium mb-4 text-blue-800">Calculateur de point de rosée</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Déterminez la température de condensation en fonction de la température ambiante et de l'humidité relative.</p>
            ...
            <div className="bg-card p-6 rounded-lg border border-blue-100 shadow-sm">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">Évaluez les risques de condensation dans les parois selon les matériaux et conditions climatiques.</p>
              <div className="text-center">
                <Button variant="outline" className="mt-2">Accéder au calculateur</Button>
              </div>
            </div>
