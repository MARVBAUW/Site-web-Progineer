    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="ec1">
        <TabsList className="mb-6 bg-purple-50 w-full justify-start overflow-x-auto">
          <TabsTrigger value="ec1" className="data-[state=active]:bg-card">
            <Atom className="h-4 w-4 mr-2" />
            <span>EC1 - Actions</span>
          </TabsTrigger>
          <TabsTrigger value="ec2" className="data-[state=active]:bg-card">
            <Columns className="h-4 w-4 mr-2" />
            <span>EC2 - Béton</span>
          </TabsTrigger>
          <TabsTrigger value="ec3" className="data-[state=active]:bg-card">
            <Ruler className="h-4 w-4 mr-2" />
            <span>EC3 - Acier</span>
          </TabsTrigger>
          <TabsTrigger value="ec5" className="data-[state=active]:bg-card">
            <BookOpen className="h-4 w-4 mr-2" />
            <span>EC5 - Bois</span>
          </TabsTrigger>
          <TabsTrigger value="ec7" className="data-[state=active]:bg-card">
