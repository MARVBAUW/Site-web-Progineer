    ...
    <div className="space-y-6">
      ...
      <Tabs value={urbanismeTab} onValueChange={setUrbanismeTab} className="mt-6">
        <TabsList className="mb-6 bg-green-50">
          <TabsTrigger value="plu" className="data-[state=active]:bg-card">
            <Map className="h-4 w-4 mr-2" />
            <span>PLU</span>
          </TabsTrigger>
          <TabsTrigger value="autorisations" className="data-[state=active]:bg-card">
            <FileText className="h-4 w-4 mr-2" />
            <span>Autorisations</span>
          </TabsTrigger>
          <TabsTrigger value="implantation" className="data-[state=active]:bg-card">
            <Ruler className="h-4 w-4 mr-2" />
            <span>Implantation</span>
          </TabsTrigger>
          <TabsTrigger value="delais" className="data-[state=active]:bg-card">
