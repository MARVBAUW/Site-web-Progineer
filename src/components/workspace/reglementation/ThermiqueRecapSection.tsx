    ...
    <div className="space-y-6">
      ...
      <Tabs value={thermiqueTab} onValueChange={setThermiqueTab} className="mt-6">
        <TabsList className="mb-6 bg-teal-50">
          <TabsTrigger value="re2020" className="data-[state=active]:bg-card">
            <Leaf className="h-4 w-4 mr-2" />
            <span>RE2020</span>
          </TabsTrigger>
          <TabsTrigger value="rt2012" className="data-[state=active]:bg-card">
            <Sun className="h-4 w-4 mr-2" />
            <span>RT2012</span>
          </TabsTrigger>
          <TabsTrigger value="renovation" className="data-[state=active]:bg-card">
            <Home className="h-4 w-4 mr-2" />
            <span>Rénovation</span>
          </TabsTrigger>
          <TabsTrigger value="calculateurs" className="data-[state=active]:bg-card">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="bg-teal-50 p-3 rounded-md">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-300">Application aux logements individuels et collectifs</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">1er juillet 2022</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Extension aux bureaux et bâtiments d'enseignement</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">2025</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Renforcement des exigences carbone</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">2028</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Nouveau renforcement carbone et énergétique</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">2031</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Exigences finales après derniers ajustements</p>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex gap-2">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="bg-teal-50 p-3 rounded-md">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-300">Test d'étanchéité à l'air obligatoire, perméabilité ≤ 0,6 m³/(h.m²)</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">Logements collectifs</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Perméabilité ≤ 1,0 m³/(h.m²), test obligatoire ou démarche qualité</p>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-md">
                    <h4 className="font-medium text-sm">Tertiaire</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-300">Modulation du Cepmax selon l'usage, éclairage pris en compte</p>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex gap-2">
      ...
      <Dialog open={!!openCalculator} onOpenChange={() => setOpenCalculator(null)}>
        <DialogContent className="max-w-4xl">
          ...
          <div className="mt-4 p-4 border rounded-md bg-muted/50">
            <p className="text-center text-low-contrast">
