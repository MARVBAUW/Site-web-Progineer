...
export const workspaceRoutes: RouteObject[] = [
  ...
  // Routes pour les pages détaillées des guides
  {
    path: "/workspace/guides/:guideId",
    element: <GuideDetailPage />,
  },
  // Routes pour les pages détaillées des calculateurs
  {
    path: "/workspace/calculators/:calculatorId",
    element: <CalculatorDetailPage />,
  },
  // Routes pour les pages détaillées de la réglementation
  {
  ...
  // Landing pages for documents (legacy)
  {
