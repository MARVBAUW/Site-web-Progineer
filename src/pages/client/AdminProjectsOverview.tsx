                ...
                <TabsContent value="list" className="space-y-6">
                  <div className="bg-card border border-border rounded-lg p-8">
                    <div className="text-center">
                      <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Liste des projets</h3>
                      <p className="text-low-contrast mb-6">Cette vue est en cours de développement.</p>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {Array.from({ length: 6 }).map((_, i) => (
                          <div key={i} className="bg-muted/50 border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
                            <h4 className="font-medium text-khaki-700 dark:text-khaki-300">Projet {i + 1}</h4>
                            <p className="text-xs text-low-contrast">Dossier #{10000 + i}</p>
