          ...
          <div className="bg-card rounded-xl p-8 shadow-md border border-border">
            {loading && !user ? (
              ...
              <div className="text-center py-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Vous êtes connecté</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">Redirection vers votre espace client...</p>
              </div>
            )}
          </div>
        </Container>
