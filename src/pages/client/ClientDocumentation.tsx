                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div className="bg-muted/50 p-4 rounded-md border border-border">
                          ...
                          <ul className="space-y-2 ml-6 list-disc text-gray-600 dark:text-gray-300">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div className="bg-muted/50 p-4 rounded-md border border-border">
                          ...
                          <ul className="space-y-2 ml-6 mt-2 list-disc text-gray-600 dark:text-gray-300">
                      ...
                      <AccordionContent value="types" className="px-4 pb-4 pt-2">
                        <div className="space-y-4">
                          <div className="bg-muted/50 p-4 rounded-md border border-border">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">Documents officiels liés à votre projet :</p>
                            <ul className="space-y-1 ml-6 mt-2 list-disc text-gray-600 dark:text-gray-300">
                          ...
                          <div className="bg-muted/50 p-4 rounded-md border border-border">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">Documents relatifs à la conception et l'exécution :</p>
                            <ul className="space-y-1 ml-6 mt-2 list-disc text-gray-600 dark:text-gray-300">
                          ...
                          <div className="bg-muted/50 p-4 rounded-md border border-border">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">Documents liés aux aspects financiers :</p>
                            <ul className="space-y-1 ml-6 mt-2 list-disc text-gray-600 dark:text-gray-300">
