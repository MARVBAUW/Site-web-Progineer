          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-card rounded-xl border border-border overflow-hidden shadow-sm">
                ...
                <div className="p-2">
                  <Link to="/workspace/client-area" className="flex items-center p-3 rounded-md text-gray-600 dark:text-gray-300 hover:bg-muted/50">
                  ...
                  <Link to="/workspace/client-area/projects" className="flex items-center p-3 rounded-md text-gray-600 dark:text-gray-300 hover:bg-muted/50">
                    <Calendar className="h-4 w-4 mr-3 flex-shrink-0" />
                    <span>Suivi de projet</span>
                  </Link>
                  <Link to="/workspace/client-area/messages" className="flex items-center p-3 rounded-md text-gray-600 dark:text-gray-300 hover:bg-muted/50">
                ...
                <CardContent>
                  ...
                  <div className="overflow-auto">
                    <table className="w-full">
                      <thead className="bg-muted/50 text-xs uppercase text-low-contrast">
                        <tr>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {filteredDocuments.length > 0 ? (
                              ...
                              <td className="px-4 py-3">
                                <div className="flex items-center">
                                  {doc.fileType === 'PDF' ? (
                                    ...
                                    <File className="h-5 w-5 mr-3 text-low-contrast" />
                                  )}
                                  <span className="font-medium">{doc.name}</span>
                                </div>
                              </td>
                              <td className="px-4 py-3 text-gray-600 dark:text-gray-300">{doc.type}</td>
                              <td className="px-4 py-3 text-gray-600 dark:text-gray-300">{doc.date}</td>
                              <td className="px-4 py-3">
                                <Badge variant={
                          ...
                          <tr>
                            <td colSpan={5} className="px-4 py-8 text-center text-low-contrast">
