              ...
              <div className="space-y-6">
                ...
                {project ? (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="border rounded-lg p-4 bg-muted/50">
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                  <span className="text-gray-600 dark:text-gray-300">Numéro de dossier:</span>
                              ...
                              <tbody>
                                <tr className="border-b">
                                  <td className="p-2">
                                    ...
                                    <div className="text-xs text-low-contrast">Fondations, structure, maçonnerie</div>
                                  </td>
                                ...
                                <tr className="border-b">
                                  <td className="p-2">
                                    ...
                                    <div className="text-xs text-low-contrast">Menuiseries, plâtrerie, revêtements</div>
                                  </td>
                                ...
                                <tr className="border-b">
                                  <td className="p-2">
                                    ...
                                    <div className="text-xs text-low-contrast">Électricité, plomberie, CVC</div>
                                  </td>
                                ...
                                <tr className="border-b">
                                  <td className="p-2">
                                    ...
                                    <div className="text-xs text-low-contrast">VRD, espaces verts, clôtures</div>
                                  </td>
                  ...
                  <div className="text-center py-8">
                    <p className="text-low-contrast">Projet non trouvé ou impossible à charger.</p>
                  </div>
                )}
              </div>
            </div>
