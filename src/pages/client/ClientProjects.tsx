              ...
              {projects.length > 0 ? (
                <div className="space-y-8">
                  {projects.map((project: any) => (
                    <Card 
                      key={project.id}
                      className="border-border hover:border-khaki-300 transition-colors"
                    >
                      ...
                      <CardContent className="pb-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                          <div className="space-y-3">
                            <div className="flex items-center text-sm">
                              ...
                              <span className="text-gray-600 dark:text-gray-300">Type: {project.type || 'Construction'}</span>
                            </div>
                            
                            <div className="flex items-center text-sm">
                              <MapPin className="w-4 h-4 mr-2 text-khaki-600" />
                              <span className="text-gray-600 dark:text-gray-300">Localisation: {project.location || 'Non définie'}</span>
                            </div>
                          </div>
                        ...
                        <div className="mt-4">
                          <div className="flex justify-between items-center mb-1">
                            <div className="text-sm text-gray-600 dark:text-gray-300">Avancement du projet</div>
