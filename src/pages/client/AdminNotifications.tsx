...
const AdminNotifications = () => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <Info className="h-5 w-5 text-gray-600 dark:text-gray-300" />;
    }
  };
                            ...
                            <div className="flex items-start">
                              ...
                              <div className="flex-1">
                                <div className="flex justify-between items-start">
                                  <h3 className={`font-medium ${notification.status === 'unread' ? 'text-khaki-900' : 'text-gray-600 dark:text-gray-300'}`}>
                                    {notification.title}
                                  </h3>
                                ...
                                <div className="flex items-center text-xs text-low-contrast mt-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div className="flex items-center space-x-3">
                            <Mail className="h-5 w-5 text-low-contrast" />
                            <div>
                              <Label htmlFor="email-notifications" className="font-medium">Notifications par e-mail</Label>
                              <p className="text-sm text-low-contrast">Recevoir des notifications par e-mail</p>
                            </div>
                          </div>
                          <Switch 
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div className="flex items-center space-x-3">
                            <Bell className="h-5 w-5 text-low-contrast" />
                            <div>
                              <Label htmlFor="push-notifications" className="font-medium">Notifications push</Label>
                              <p className="text-sm text-low-contrast">Recevoir des notifications dans l'application</p>
                            </div>
                          </div>
                          <Switch 
