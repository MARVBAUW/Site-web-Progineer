...
const Estimation = () => {
  ...
  const faqItems = [
    {
      ...
      answer: "Le coût moyen de construction d'une maison neuve en région PACA se situe entre 1500€ et 2500€ par m². Ce prix varie selon la complexité architecturale, les matériaux sélectionnés, la topographie du terrain et les contraintes locales. Notre outil d'estimation vous permet de calculer précisément votre budget en fonction des spécificités de votre projet. Consultez nos services de construction neuve pour plus de détails."
    },
    {
      question: "Comment estimer le coût d'une rénovation complète ?",
      answer: "Pour estimer le coût d'une rénovation complète, plusieurs facteurs sont à considérer : l'état initial du bâtiment, l'ampleur des travaux (structure, isolation, électricité, plomberie), la qualité des finitions et les éventuelles contraintes techniques. En moyenne, comptez entre 800€ et 1800€/m² pour une rénovation en PACA. Notre estimation détaillée vous fournit un chiffrage précis corps de métier par corps de métier. Découvrez nos services de rénovation et réhabilitation."
    },
    {
      question: "Quels sont les facteurs qui influencent le prix des travaux de construction ?",
      answer: "Les principaux facteurs qui influencent le prix des travaux de construction sont : la surface à construire, la qualité des matériaux, la complexité architecturale, la topographie du terrain, l'accessibilité du chantier, les contraintes réglementaires locales et les choix techniques (fondations, isolation, équipements). Notre outil d'estimation prend en compte tous ces éléments pour vous fournir un budget prévisionnel précis. Consultez nos prestations complètes pour plus d'informations."
    },
    {
      question: "Combien coûtent les travaux de plomberie dans une construction neuve ?",
      answer: "Les travaux de plomberie dans une construction neuve représentent généralement entre 5% et 8% du budget total. Pour une maison standard, comptez environ 80€ à 120€/m² pour une installation complète incluant l'arrivée d'eau, l'évacuation, la distribution et les équipements sanitaires. Notre estimation détaillée vous permet de connaître précisément ce poste de dépense pour votre projet spécifique. Pour un accompagnement personnalisé, n'hésitez pas à nous contacter."
    }
  ];
  ...
  return (
    <>
      <SEO 
        title="Estimation Construction & Rénovation à Marseille, Cannes, Saint-Tropez, Fréjus"
      ...
      <main>
        ...
        >
          <EstimationHero />
          <SEOContentSection
            title="Guide complet pour estimer vos travaux"
      ...
      <SEOFooter 
        text="Estimation précise et personnalisée pour tous vos projets de construction et rénovation en PACA. Notre outil calcule le coût exact de votre projet au m² à Marseille, Nice, Toulon et partout en Provence-Alpes-Côte d'Azur. Découvrez nos réalisations et notre équipe d'experts."
        additionalKeywords={[
