    ...
    <>
      ...
      <section className="py-16 bg-background">
        <Container size="lg">
          ...
          <h2 className="text-xl md:text-2xl font-medium mb-8 text-gray-600 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {siteStructure.map((section, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">{section.title}</h3>
          ...
          <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-sm">
            <h3 className="text-xl font-medium mb-4 text-gray-900 dark:text-white">Ressources XML</h3>
