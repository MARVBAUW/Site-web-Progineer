...
const teamMembers = [
  {
    ...
    image: '/lovable-uploads/3f77f084-4061-4e36-9f32-85cb08372b51.webp',
  ...
  },
  {
    ...
    image: '/lovable-uploads/23fe2b30-1f84-472d-a3c8-d4c413ffbbc4.webp',
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Hero section */}
        <section className="pt-32 pb-16 bg-gradient-to-b from-stone-50 to-white dark:from-slate-800 dark:to-slate-900">
          <Container size="md">
